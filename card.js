...
function BtnClick(event) {
    ...
    if (event.target.className === "mBtn small") {
        ...
        smallPizzaTotal.innerHTML = (smallQty * 32).toFixed(2);
        medPizzaTotal.innerHTML = (medQty * 56).toFixed(2);
        largePizzaTotal.innerHTML = (largeQty * 68).toFixed(2);
        totalCart = smallQty * 32.00 + medQty * 56.00 + largeQty * 68.00;
